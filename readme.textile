...
|delay|Integer|300|"See jQuery UI documentation":http://jqueryui.com/demos/autocomplete/#option-delay|
|disabled|Boolean|false||
|height|Integer|400||
|minLength|Integer|1|"See jQuery UI documentation":http://jqueryui.com/demos/autocomplete/#option-minLength|
|modal|Boolean|true||
|name|String|null||
...
|source|String, Array, Callback|none, must be specified|"See jQuery UI documentation":http://jqueryui.com/demos/autocomplete/#option-source|
|title|String|'Search'||
|value|Object|null||
|width|Integer|600||
